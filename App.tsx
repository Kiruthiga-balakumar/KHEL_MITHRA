...
import AtheleteSignUp from "./components/AtheleteSignUp";
import SAILogin from "./components/SAILogin";
import AthletePasswordSet1 from "./components/AthletePasswordSet1";
import SponsorLogin from "./components/SponsorLogin";
import Events from "./components/Events";
import AiNutritionChart from "./components/AiNutritionChart";
import AiNutrionist from "./components/AiNutrionist";
import BadgesRewards from "./components/BadgesRewards";
  ...
  return (
    <>
      <NavigationContainer>
        {hideSplashScreen ? (
          <Stack.Navigator
            initialRouteName="FrameComponent6"
